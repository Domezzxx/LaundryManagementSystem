...
public class MachineEditDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        String[] types = {"เครื่องซักผ้า", "ซัก", "ซักแห้ง", "ซักรีด"};
        ...
        String[] statuses = {"พร้อมใช้งาน", "เสร็จสิ้น", "กำลังทำงาน", "ไม่ว่าง", "ไม่พร้อมใช้งาน"};
        ...
        // Set custom renderer for colored status
