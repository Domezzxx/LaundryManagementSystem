...
public class LaundryRegister extends JFrame {
    ...
    // Thai text constants using proper encoding
    ...
    public LaundryRegister() {
        ...
        // Add component listener to handle window resize and centering
        ...
        // Initialize components but don't set bounds yet
    ...
    private void centerComponents() {
        ...
        // Calculate starting Y position to vertically center the form
        int totalHeight = 80 + 30 + (verticalSpacing * 6) + 45 + 20; // title + subtitle + fields + button + spacing
