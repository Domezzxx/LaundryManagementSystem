...
public class StatusCheckFrame extends JFrame implements OrderManager.StatusChangeListener {
    ...
    // ✅ 2. แก้ Constructor ให้รับ username เข้ามาด้วย
    ...
    // Constructor สำรอง (เผื่อมีที่อื่นเรียกแบบเก่าจะได้ไม่ Error แต่แนะนำให้ใช้อันบน)
        ...
        profileItem.addActionListener(e -> {
            ...
            profileFrame.addWindowListener(new WindowAdapter() {
                ...
                public void windowClosed(WindowEvent e) {
                    StatusCheckFrame.this.setVisible(true); // กลับมาแสดงหน้า Home
                }
            });
    ...
    private void goBackToHome() {
        ...
        SwingUtilities.invokeLater(() -> {
            // ✅ 3. ใช้ตัวแปร currentUsername แทน authResult
    ...
    private void cancelCurrentOrder() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            // เรียกใช้ OrderManager เพื่ออัพเดทสถานะเป็น "ยกเลิก"
