...
public class LoginFrame extends JFrame {
    ...
    public LoginFrame() {
        ...
        // Main panel that fills the entire screen
        ...
        // Content panel with two sections (70% left, 30% right)
        ...
        // Left panel (Login section) - 50% width
        ...
        // Right panel (Welcome section) - 30% width
        ...
        // Add panels to content panel with weight distribution (70-30)
        contentGbc.gridx = 0;
    ...
    // ✅ เพิ่มฟิลด์ username ใน AuthResult
    ...
    private AuthResult authenticateUser(String username, String password) {
        try (Connection conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD)) {
            ...
            // Employee query (ยังคงเหมือนเดิม หรือจะเพิ่ม username ด้วยก็ได้)
    ...
    // -------------------------
    // ฟอนต์แก้ปัญหาภาษาไทยเป็นสี่เหลี่ยม
    // -------------------------
