...
public class HomeFrame extends JFrame {
    ...
    // =======================================================
    // 🟢 แก้ไขตรงนี้: ใช้ท่าเดียวกับ Logo เป๊ะๆ
    // =======================================================

    private ImageIcon createServiceIcon(String iconName) {
        int size = 100;
        try {
            // ✅ ใช้ท่าเดียวกับ Logo เลย: getClass().getResource("/ชื่อไฟล์.png")
            // หมายเหตุ: ไฟล์รูปต้องอยู่ที่เดียวกับ Ellipse_100.png (ใน resources หรือ src หน้าแรก)
            ...
            // ปล่อยผ่านเหมือน Logo
        }

        // ถ้าหาไม่เจอ ให้ไปสร้างรูปสำรอง
        String serviceName = "";
        return createDefaultIconFallback(serviceName, size);
    }


    // สร้างไอคอนสำรองในกรณีโหลดรูปไม่ได้
    ...
    private ImageIcon createLogoIcon() {
        int size = 70;
        try {
            // ✅ โหลดโลโก้จาก resources (ตัวเล็ก)
