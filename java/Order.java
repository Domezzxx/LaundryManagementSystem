...
public class Order {
    ...
    /**
     * Constructor แบบมี parameter หลัก
     */
    ...
    /**
     * Constructor แบบครบทุก parameter
     */
    ...
    /**
     * ตรวจสอบว่า Order นี้เป็นสถานะที่กำหนดหรือไม่
     */
    ...
    /**
     * ตรวจสอบว่าเป็นสถานะ "รอดำเนินการ"
     */
    ...
    /**
     * ตรวจสอบว่าเป็นสถานะ "กำลังดำเนินการ"
     */
    ...
    /**
     * ตรวจสอบว่า Order สามารถแก้ไขได้หรือไม่
     * (ไม่สามารถแก้ไขถ้ายกเลิกแล้ว)
     */
    ...
    /**
     * ตรวจสอบว่า Order สามารถยกเลิกได้หรือไม่
     * (ไม่สามารถยกเลิกถ้าเสร็จสิ้นหรือยกเลิกแล้ว)
     */
    ...
    /**
     * แปลง Date เป็น String format dd/MM/yyyy HH:mm
     */
    ...
    /**
     * แปลง Pickup Date เป็น String format (รองรับทั้ง Date และ Timestamp)
     * - ถ้าเป็น Timestamp จะแสดง: dd/MM/yyyy HH:mm
     * - ถ้าเป็น Date จะแสดง: dd/MM/yyyy
     */
    public String getPickupDateFormatted() {
        ...
        if (pickupDate instanceof java.sql.Timestamp) {
            // ถ้าเป็น Timestamp แสดงทั้งวันและเวลา
            sdf = new SimpleDateFormat("dd/MM/yyyy HH:mm");
        } else {
            // ถ้าเป็น Date แสดงแค่วัน
    ...
    /**
     * แปลงราคาเป็น String พร้อมสกุลเงิน
     */
    ...
    /**
     * แสดงข้อมูลแบบละเอียด (เวอร์ชันเดิม)
     * NOTE: เมธอดนี้ถูกปรับให้เรียกเมธอดใหม่โดยส่งรายการว่างเข้าไป เพื่อรักษา compatibility
     */
    ...
    /**
     * แสดงข้อมูลแบบละเอียด พร้อมรายการซักผ้า (เวอร์ชันที่ถูกเรียกใช้จริง)
     * @param orderDetails รายการรายละเอียดการซักผ้าที่ดึงมาจากฐานข้อมูล
     */
    public String toDetailedString(List<String> orderDetails) {
        ...
        if (orderDetails == null || orderDetails.isEmpty()) {
            ...
            // แสดงรายการซักผ้าแต่ละรายการ
            for (String detail : orderDetails) {
                // จัดรูปแบบข้อความให้พอดีกับกรอบ
    ...
    /**
     * เปรียบเทียบ Order 2 ตัวตามวันที่สั่ง (ใหม่สุดก่อน)
     */
    ...
    /**
     * เปรียบเทียบ Order 2 ตัวตามวันรับผ้า
     */
    ...
    /**
     * เปรียบเทียบ Order 2 ตัวตามราคา
     */
