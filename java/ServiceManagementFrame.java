...
public class ServiceManagementFrame extends JFrame implements OrderManager.StatusChangeListener {
    ...
    private JPanel createTablePanel() {
        ...
        //  ใช้ DefaultTableModel เพราะเราเรียงข้อมูลเก่่อนใส่ตาราง
    ...
    public void onStatusChanged() {
        SwingUtilities.invokeLater(() -> {
            refreshTableData(); // เมื่อสถานะเปลี่ยน ก็ให้โหลดและเรียงใหม่ตามที่ตั้งค่าไว้
        });
    }
    ...
    class ButtonEditor extends DefaultCellEditor {
        ...
        public ButtonEditor(JCheckBox checkBox) {
            ...
            button.addActionListener(e -> {
                ...
                // ใช้ตารางปัจจุบันดึง ID มาเลย เพื่อความแม่นยำหลังการ Sort
