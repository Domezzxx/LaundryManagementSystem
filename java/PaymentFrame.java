...
public class PaymentFrame extends JFrame {
    ...
    public PaymentFrame(List<BookingFrame.OrderItem> items, int total, String date, String time, String customerName, int customerId, HomeFrame homeFrame) {
        ...
        // ✅ แก้ไข 1: เปิดการใช้งาน WindowListener เพื่อให้กลับหน้า Home เมื่อกดปิด
    ...
    private void initComponents() {
        setTitle("ชำระเงิน");
        setSize(1920,1080);
        // ✅ เปลี่ยนเป็น DO_NOTHING เพื่อให้ WindowListener จัดการเอง
    ...
    private void processPayment(String paymentMethod) {
        ...
        // แปลงวันที่จาก "14/12/2025" เป็น "2025-12-14"
        String sqlDate = "";
        try {
        ...
        if (orderId > 0) {
            ...
            // ✅ แก้ไข 2: เรียกใช้ HomeFrame ให้กลับมาแสดงผล
            if (homeFrame != null) {
                homeFrame.setVisible(true);
            }
            dispose();
    ...
    private int saveOrderToDatabase(String paymentMethod, String sqlDate) {
        ...
        try {
            ...
            // บันทึกรายละเอียดรายการ (Order Details)
