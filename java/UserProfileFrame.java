...
public class UserProfileFrame extends JFrame {
    ...
    private JPanel createMenuPanel() {
        ...
        panel.add(createMenuItem("🚪", "ออกจากระบบ", e -> {
            int confirm = JOptionPane.showConfirmDialog(this, "ยืนยันการออกจากระบบ?", "Logout", JOptionPane.YES_NO_OPTION);
            if (confirm == JOptionPane.YES_OPTION) {
                this.dispose();
                // หมายเหตุ: ถ้าออกจากระบบตรงนี้ หน้า HomeFrame จะเด้งขึ้นมาก่อน (เพราะ WindowListener)
                // ถ้าต้องการให้ Logout ไปหน้า Login เลย ต้องจัดการที่ HomeFrame หรือส่ง Status กลับไป
            }
        }));
