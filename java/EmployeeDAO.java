...
public class EmployeeDAO {
    ...
    // ดึงข้อมูลพนักงานทั้งหมด (เรียงตาม employee_id)
    ...
    // ค้นหาพนักงาน (ตาม ID, ชื่อ, Username)
    ...
    public boolean addEmployee(Employee employee) {
        // ปรับ SQL: ตัด LastName และ PhoneNumber เหลือ 5 พารามิเตอร์ (?,?,?,?,?)
