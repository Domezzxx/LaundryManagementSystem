...
public class StaffManagementFrame extends JFrame {
    ...
    private JPanel createSearchPanel() {
        ...
        String[] sortOptions = {"เรียงตามรหัส", "เรียงตามตำแหน่ง (สูง-ต่ำ)"};
    ...
    private JPanel createTablePanel() {
        ...
        // 3. ตั้งค่าความกว้างของแต่ละคอลัมน์ใหม่ (index เปลี่ยน)
        employeeTable.getColumnModel().getColumn(0).setPreferredWidth(120);  // รหัส (ย้ายมาเป็น 0)
        employeeTable.getColumnModel().getColumn(1).setPreferredWidth(150);  // ชื่อ
        employeeTable.getColumnModel().getColumn(2).setPreferredWidth(120);  // Username
        employeeTable.getColumnModel().getColumn(3).setPreferredWidth(100);  // Password
        employeeTable.getColumnModel().getColumn(4).setPreferredWidth(150);  // ตำแหน่ง
        employeeTable.getColumnModel().getColumn(5).setPreferredWidth(130);  // จัดการ (ย้ายไปเป็น 5)

        // 4. จัดข้อความให้อยู่กลางสำหรับคอลัมน์ข้อมูล (0-4)
        ...
        // 5. ตั้งค่าปุ่มในคอลัมน์สุดท้าย (Index 5)
    ...
    private void loadEmployeeData() {
        ...
        for (Employee emp : employees) {
            // สลับลำดับข้อมูลให้ตรงกับหัวตาราง
    ...
    // ฟังก์ชันช่วยกำหนดลำดับความสำคัญของตำแหน่ง (ยิ่งสูงค่ายิ่งมาก)
    ...
    class IconButtonEditor extends DefaultCellEditor {
        ...
        public IconButtonEditor(JCheckBox checkBox) {
            ...
            // --- ตั้งค่าสไตล์ปุ่มให้เหมือนกับ Renderer ---
            ...
            button.addActionListener(e -> {
                fireEditingStopped(); // หยุดสถานะการแก้ไขเพื่อให้ตารางกลับมาเป็นปกติ
