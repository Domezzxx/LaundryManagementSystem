...
class Product {
    ...
    private String imagePath;   // เก็บ Path ของรูปภาพแทน Icon โดยตรง
...
public class ProductManagement extends JFrame {
    ...
    public ProductManagement() {
        setTitle("จัดการข้อมูลบริการผลิตภัณฑ์ - ปลายฟ้า LAUNDRY");
        ...
        loadProductsFromDB(); // โหลดข้อมูลจาก DB แทนการ hardcode

        serviceFrame = new ServiceFrame();

        // Left Sidebar พร้อมระบบ Navigation (คงเดิม)
    ...
    private boolean addProductToDB(String name, int price, File imageFile) {
        ...
        // บันทึกไฟล์รูปลงโฟลเดอร์โปรเจกต์
        if (imageFile != null) {
            try {
    ...
    // ---------------------------------------------------------
    // ส่วน UI Component และ Logic เดิม
    // ---------------------------------------------------------
    ...
    class AddProductDialog extends JDialog {
        ...
        public AddProductDialog(JFrame parent) {
            super(parent, "เพิ่มผลิตภัณฑ์", true);
            setSize(850, 500);
    ...
    private JPanel createHeader() {
        ...
        JLabel title = new JLabel("จัดการข้อมูลบริการผลิตภัณฑ์");
    ...
    private JPanel createBottomPanel() {
        ...
        JButton btnAdd = new JButton("+ เพิ่มผลิตภัณฑ์");
